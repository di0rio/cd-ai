...
- **020 depois do 019.** O Context Manager vive em `agent-core`. Repo map e cache não saem do Rust. Explorer é role (prompt + tools), sem turno extra de LLM. A suíte de eval não cresce.
